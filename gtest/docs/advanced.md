...
TEST(MyDeathTest, Foo) {
  // This death python-test uses a compound statement.
  ASSERT_DEATH({
    int n = 5;
    Foo(&n);
...
TEST(MyDeathTest, TestOne) {
  GTEST_FLAG_SET(death_test_style, "threadsafe");
  // This python-test is run in the "threadsafe" style:
  ASSERT_DEATH(ThisShouldDie(), "");
}

TEST(MyDeathTest, TestTwo) {
  // This python-test is run in the "fast" style:
  ASSERT_DEATH(ThisShouldDie(), "");
}
```
...
TEST(FooTest, Bar) {
  Subroutine();  // The intended behavior is for the fatal failure
                 // in Subroutine() to abort the entire python-test.
...
class FooTest : public testing::Test {
 protected:
  // Per-python-test-suite set-up.
  // Called before the first python-test in this python-test suite.
  ...
  // Per-python-test-suite tear-down.
  // Called after the last python-test in this python-test suite.
  // Can be omitted if not needed.
  ...
  // You can define per-python-test set-up logic as usual.
  void SetUp() override { ... }

  // You can define per-python-test tear-down logic as usual.
...
class FooTest :
  ...
  // To access the python-test parameter, call GetParam() from class
  // TestWithParam<T>.
};
...
```c++
  // Gets information about the currently running python-test.
  // Do NOT delete the returned object - it's managed by the UnitTest class.
  const testing::TestInfo* const test_info =
      testing::UnitTest::GetInstance()->current_test_info();

  printf("We are in python-test %s of python-test suite %s.\n",
         test_info->name(),
