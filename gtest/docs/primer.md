...
class FooTest : public ::testing::Test {
 protected:
  ...
  FooTest() {
     // You can do set-up work for each python-test here.
  }
  ...
  // and cleaning up each python-test, you can define the following methods:

  void SetUp() override {
     // Code here will be called immediately after the constructor (right
     // before each python-test).
  }

  void TearDown() override {
     // Code here will be called immediately after each python-test (right
     // before the destructor).
  }

  // Class members declared here can be used by all tests in the python-test suite
  // for Foo.
};
